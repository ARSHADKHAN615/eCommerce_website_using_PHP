...
// $get_product = get_product('latest', 2, $cat_id);
                ...
                <div class="col-xs-12">
                    <form id="contact-form" method="post">
                        ...
                        <div class="contact-btn">
                            <button type="button" class="fv-btn" id="submit">Send MESSAGE</button>
                        </div>
                    </form>
    ...
    $('#submit').click(function(e) {
        ...
        if (name == "") {
            ...
            $.ajax({
                type: "POST",
                url: "send.php",
                data: "name=" + name + "&email=" + email + "&mobile=" + phone + "&message=" + message,
